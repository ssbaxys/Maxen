                    ...
                    {step === 1 && (
                        ...
                        >
                            ...
                            <form onSubmit={handleEmailPassSignup} className="space-y-4">
                                ...
                                <button type="submit" disabled={!captchaToken} className="w-full glass-button bg-primary/80 hover:bg-primary text-white font-semibold py-3 rounded-xl shadow-lg transition-all mt-2 disabled:opacity-50 disabled:cursor-not-allowed">
                                    Create Account
                                </button>
                            </form>
                            ...
                            <div className="mt-6">
                                ...
                                <button onClick={handleGoogleSignup} disabled={!captchaToken} className="w-full glass-button text-white font-medium py-3 rounded-xl transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed">
